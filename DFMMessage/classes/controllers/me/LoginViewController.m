...
-(void)viewDidLoad{
    ...
    [center addObserver:self selector:@selector(registerMiss) name:@"registerMiss" object:nil];
...
-(void)dealloc{
    ...
    _userFace = nil;
    _loginView = nil;
     [[NSNotificationCenter defaultCenter]removeObserver:self name:@"registerMiss" object:nil];
}
-(void)registerMiss{
...
-(void)initViews{
    ...
    _userName = [[UITextField alloc] initWithFrame:CGRectMake(x, y+100, w, h+5)];
...
- (void)LoginButton{
    ...
    [defaults setObject:kHostName forKey:SERVER];
    //保存
